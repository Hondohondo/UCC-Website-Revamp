<div class="container">
    ...
    <div class="d-flex justify-content-around">
        ...
        <img class="partner-img" height="48px" width="273px" src="/img/sophos.png" alt="">
        <img class="partner-img" height="48px" width="139px" src="/img/mdh.png" alt="">
        <img class="partner-img" height="48px" width="133px" src="/img/pepfar.png" alt="">
    </div>
</div>